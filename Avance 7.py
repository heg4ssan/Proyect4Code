...
def crear_grid(ancho, alto):           
    ...
    for fila in range(alto):           
        ...
        for columna in range(ancho):   
            new_list.append(0)         
        grid.append(new_list)                              #En estas dos funciones son donde uso matrices (avance 7)
    return grid
...
"""
En este avance 7 icorpore mi funcion main, que imprime con condiciones iniciales, luego en un ciclo while, borra la posicion anterior del usuario, luego lee el movimiento que tecleo 
